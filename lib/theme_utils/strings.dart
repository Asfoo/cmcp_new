...
const base_url = "https://cmcc.balochistan.gob.pk";
const user_image_path = base_url + "/uploads/avatar";
const cat1_icon = base_url + "/icons/cat";
const user_attach_path = base_url + "/uploads/files";
const track_attach_path = base_url + "/uploads/attachments";
const coach_image_path = "app/image/avatar";
const sport_image_path = "app/image/sports";
const default_url = base_url + "/api/app";
// const user_image_path = "http";

const t3_hint_password = "Password";
const t3_lbl_remember = "Remember";
const t3_hint_Email = "CNIC";
...
const t3_lbl_welcome_to_bottom_n_navigation_bar =
    "Welcome to Bottom \nNavigation Bar";
