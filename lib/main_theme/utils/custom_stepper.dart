...
class _CustomStepperState extends State<CustomStepper>
  ...
  Widget _buildCircleChild(int index, bool oldState, {int length = 0}) {
    final CustomStepState state =
  ...
  Widget _buildCircle(int index, bool oldState, {int length = 0}) {
    return Container(
  ...
  Widget _buildIcon(int index, {int length = 0}) {
    if (widget.steps[index].state != _oldStates[index]) {
      return AnimatedCrossFade(
        firstChild: _buildCircle(index, true, length: length),
      ...
      if (widget.steps[index].state != StepState.error)
        return _buildCircle(index, false, length: length);
      else
  ...
  Widget _buildVerticalHeader(int index, {int length = 0}) {
    return Container(
        ...
        children: <Widget>[
          Column(
            children: <Widget>[
              ...
              _buildIcon(index, length: length),
          ...
          Column(
            ...
            children: <Widget>[
              InkWell(
                ...
                child: _buildVerticalHeader(i, length: widget.steps.length),
              ),
